...
function FeatureList() {
    return (
        <SectionContent title="주요기능" marginBottom={139}>
            <div className="w-full flex justify-end items-start gap-[37px] mb-[42px] mt-[22.5px]">
                <FeatureCard
                    index={1}
                    title="AI 기반 자동분석"
                    desc={`NLP, 딥러닝 등을 통해 자기소개서와 이력서를 정량화,\n3D 그래프나 대시보드로 결과를 시각화함`}
                />
                <FeatureCard
                    index={2}
            ...
            <div className="w-full flex justify-end items-start gap-[37px] mb-[42px]">
                ...
                <FeatureCard
                    index={4}
                    title="재평가 루프"
                    desc={`3~6개월 간격으로 재평가를 실시해 역량 변화 추이를 파악,\n목표치를 제시함으로써 지속 성장과 역량 고도화를 지원`}
                />
            </div>
        </SectionContent>
    )
