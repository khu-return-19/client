...
function MainSectionLayout() {
  return (
    <section className="w-full h-full relative bg-[#00010d]">
      <style>{`
      ...
      `}</style>
      <div className="absolute bottom-[-20%] left-[-15%] orbit-a w-[61.5vw] h-[51.1vw]" style={{ filter: "blur(150px)" }}>
        <BottomLeftLarge />
      </div>
      <div className="absolute bottom-[-10%] left-[-5%] orbit-b w-[33.8vw] h-[51.1vw]" style={{ filter: "blur(80px)" }}>
        <BottomLeftSmall />
      </div>
      <div className="absolute top-[-20%] right-[-15%] orbit-b w-[96.6vw] h-[50.97vw]" style={{ filter: "blur(150px)" }}>
        <TopRightLarge />
      </div>
      <div className="absolute top-[-10%] right-[-5%] orbit-c w-[76.6vw] h-[28.7vw]" style={{ filter: "blur(80px)" }}>
        <TopRightSmall />
      </div>
      <div className="absolute bottom-[-10%] right-[-5%] orbit-a w-[50.5vw] h-[30.8vw]" style={{ filter: "blur(80px)" }}>
        <BottomRight />
      </div>
